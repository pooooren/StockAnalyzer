...
namespace big
{
    ...
    public class MySqlHelper
    {
        ...
        /// <param name="CommandType.Text">命令类型(存储过程, 文本, 等等)</param>
        ...
        /// <param name="commandParameters">执行命令所用参数的集合</param>
        /// <returns>执行命令所影响的行数</returns>
        public static int ExecuteNonQuery(MySqlConnection connection, string cmdText, params MySqlParameter[] commandParameters)
        {
        ...
        /// <param name="CommandType.Text">命令类型例如 存储过程或者文本</param>
